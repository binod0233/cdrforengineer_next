...
`,
     ...
     `,
      ...
      fancySteps: [
        ...
        },
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>“Design and construction of hybrid wireless mesh network”
 
              <br />
              Over the Second career episode Report, the writer describes the engineering abilities he utilized in a project during his bachelor’s studies. The project is called the 
        ...
        },
        {
          ...
          details: (
            <div>
              ...
              <br />
              Over the Third career episode Report, the author outlines the project he was involved in during his undergraduate program. The project is called “Long Term Evolution Technology “. 
              <strong>
                “Extension to MAC 802.11 for Performance Enhancement in MANET
                “.{" "}
              </strong>
      ...
      fancySteps: [
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>“Preparing design and drawings of sanitary drainage and storm-water system pipework”
              ...
              The author outlines a project he worked on while completing his undergraduate coursework.
              <strong>The author's responsibilities Includes:</strong>
              <br />
              <br />
              <i className="fa-solid fa-check me-2"></i>
        ...
        },
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong> “Preparing plan, section, and details drawings of concrete frame structures of a residential building”
 
              <br />
              Over the Second career episode Report, the writer describes the engineering draftsperson’s abilities, he utilized in a project during his studies. The project is called the 
 ...
 <br />
        ...
        },
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>“Drawings and design of plumbing work of a residential building in Tehran, Iran “
              <br />
              Over the Third career episode Report, the author outlines the project he was involved in during his undergraduate program. The project is 
              <strong>
              “Drawings and design of plumbing work of a residential building in Tehran, Iran “. 
      ...
      fancySteps: [
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>: “Appropriate Design and Operation of Wastewater Treatment Plants”. 
              ...
              project:
              <strong>
              “Appropriate Design and Operation of Wastewater Treatment Plants”. 
        ...
        },
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong> : “Construction of a solid 3D model of geology in Sardinia using GIS methods”
        ...
        },
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>“Construction of a solid 3D model of geology in Sardinia using GIS methods”.
              <br />
              Over the Third career episode Report, the author outlines the project he was involved in during his undergraduate program. The project is called 
              <strong>
      ...
      fancySteps: [
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>: “Optimal Allocation of Static and Dynamic Reactive Power Support for Enhancing Power System Security”
 


              <br />
              <br />
              Over the first career episode Report, the author explains the project: 
              <strong>
        ...
        },
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>“Evaluation of Microwave Microscopy for Dielectric Characterization”
      ...
      fancySteps: [
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>: : “DSLAM - CEN migration, network design, implementation, configuration and integration of IP network”
              ...
              Over the first career episode Report, the author explains the project: 
              <strong>
              “DSLAM - CEN migration, network design, implementation, configuration and integration of IP network”
              </strong>
              The author outlines a project he worked on while completing his undergraduate coursework.
              <strong>The author's responsibilities Includes:</strong>
              <br />
        ...
        },
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>“Mobile network setup, site planning, hardware installation planning”

 
              <br />
              Over the Second career episode Report, the writer describes the engineering abilities he utilized in a project during his bachelor’s studies. The project is called the    
              <strong> “Mobile network setup, site planning, hardware installation planning”
</strong>
              <br />
              <strong>The Author’s Duties and Responsibilities Include:</strong>
              <i className="fa-solid fa-check me-2"></i>
...
<br />
 ...
 <br />
        ...
        },
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>“Banking project: operation and network maintenance support, hardware support, configuration management and migration support “

              <br />
              Over the Third career episode Report, the author outlines the project he was involved in during his undergraduate program. The project is called 
                            <strong>
              “Banking project: operation and network maintenance support, hardware support, configuration management and migration support “ 
              </strong>
              <br />
              <br />
              <strong>Writer’s Duties and Responsibilities Include:</strong>
      ...
      fancySteps: [
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>“Emissions Detector for Pinpointing the Urban Environment for Energized Objects”
              ...
              Over the first career episode Report, the author explains the project: 
              <strong>
              “Emissions Detector for Pinpointing the Urban Environment for Energized Objects”
              </strong>
        ...
        },
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>“Determination of framework for the reliability of Nano-Scale Semiconductor Device (MOS)”

 
              <br />
              Over the Second career episode Report, the writer describes the engineering abilities he utilized in a project during his bachelor’s studies. The project is called the  
              <strong>“Determination of framework for the reliability of Nano-Scale Semiconductor Device (MOS)”
</strong>
              <br />
              <strong>The Author’s Duties and Responsibilities Include:</strong>
              <i className="fa-solid fa-check me-2"></i>
...
<br />
 ...
 <br />
        ...
        },
        {
          ...
          details: (
            <div>
              <strong>Project Name:</strong>“Design, Manufacture, and Assembly of a Flexible Thermoelectric Device”

              <br />
              Over the Third career episode Report, the author outlines the project he was involved in during his undergraduate program. The project is called  
                            <strong>
                            “Design, Manufacture, and Assembly of a Flexible Thermoelectric Device” 
              </strong>
              <br />
              <br />
              <strong>Writer’s Duties and Responsibilities Include:</strong>
    ...
    <div>
      ...
      <>
        ...
        {name === "material-engineer" && (
           ...
           <meta name='description' content='CDR Samples For Material Engineer | CDR For Engineer'/>
           <link rel="canonical" href={canonicalUrl} />
      ...
      {name === "engineering-manager" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.engineeringManager.secondTitleSecond}
      ...
      {name === "chemical-engineer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.chemicalEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
              allSamples.chemicalEngineer?.secondTitleSecondDetails
            }
          />
          <Steps tabItem={allSamples.chemicalEngineer?.steps} />
          <ReportSamples fancySteps={allSamples.chemicalEngineer?.fancySteps} />
        </>
      )}
      ...
      {name === "material-engineer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.materialsEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
              allSamples.materialsEngineer?.secondTitleSecondDetails
            }
          />
          <Steps tabItem={allSamples.materialsEngineer.steps} />
          <ReportSamples fancySteps={allSamples.materialsEngineer.fancySteps} />
        </>
      )}
      ...
      {name === "civil-engineer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.civilEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
              allSamples.civilEngineer?.secondTitleSecondDetails
            }
          />
          <Steps tabItem={allSamples.civilEngineer?.steps} />
          <ReportSamples fancySteps={allSamples.civilEngineer?.fancySteps} />
        </>
      )}
      ...
      {name === "structural-engineer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.structuralEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
      ...
      {name === "transport-engnieer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.transportEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
      ...
      {name === "electrical-engineer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.electricalEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
      ...
      {name === "industrial-engineer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.industrialEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
      ...
      {name === "mechanical-engineer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.mechanicalEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
      ...
      {name === "production-or-plant-engineer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.productionEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
      ...
      {name === "mining-engineer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.miningEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
              allSamples.miningEngineer?.secondTitleSecondDetails
            }
          />
          <Steps tabItem={allSamples.miningEngineer?.steps} />
          <ReportSamples fancySteps={allSamples.miningEngineer?.fancySteps} />
        </>
      )}
      ...
      {name === "petroleum-engineer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.petroleumEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
      ...
      {name === "biomedical-engineer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.biomedicalEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
       ...
       {name === "engineering-technologist" && (
        <>
          <CDRSample
            ...
            titleDetails={allSamples.engineeringTechnologist?.titleDetails}
      ...
      {name === "engineering-professionals" && (
        <>
          <CDRSample
            ...
            titleDetails={allSamples.engineeringProfessionals?.titleDetails}
            ...
            secondTitleSecondDetails={
              allSamples.engineeringProfessionals?.secondTitleSecondDetails
            }
          />
      ...
      {name === "computer-network-and-system-engineer" && (
        <>
          <CDRSample
            ...
            secondTitleSecond={allSamples.computerEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
              allSamples.computerEngineer?.secondTitleSecondDetails
            }
          />
          <Steps tabItem={allSamples.computerEngineer?.steps} />
          <ReportSamples fancySteps={allSamples.computerEngineer?.fancySteps} />
        </>
      )}
      ...
      {name === "telecommunication-engineer" && (
        <>
          <CDRSample
            ...
            titleDetails={allSamples.telecommunicationEngineer?.titleDetails}
            image={allSamples.telecommunicationEngineer?.image}
            secondTitle={allSamples.telecommunicationEngineer?.secondTitle}
            secondTitleSecond={
              allSamples.telecommunicationEngineer?.secondTitleSecond
            }
            secondTitleSecondDetails={
              allSamples.telecommunicationEngineer?.secondTitleSecondDetails
            }
          />
...
{name === "telecommunications-network-engineer" && (
        <>
          <CDRSample
            ...
            titleDetails={allSamples.telecommunicationsNetworkEngineer?.titleDetails}
            image={allSamples.telecommunicationsNetworkEngineer?.image}
            secondTitle={allSamples.telecommunicationsNetworkEngineer?.secondTitle}
            secondTitleSecond={allSamples.telecommunicationsNetworkEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
              allSamples.telecommunicationsNetworkEngineer?.secondTitleSecondDetails
            }
           
          />
          <Steps tabItem={allSamples.telecommunicationsNetworkEngineer?.steps} />
          <ReportSamples
            fancySteps={allSamples.telecommunicationsNetworkEngineer?.fancySteps}
          />
        </>
      )}
        ...
        <>
          <CDRSample
            ...
            titleDetails={allSamples.electricalEngineeringTechnician?.titleDetails}
            image={allSamples.electricalEngineeringTechnician?.image}
            secondTitle={allSamples.electricalEngineeringTechnician?.secondTitle}
            secondTitleSecond={allSamples.electricalEngineeringTechnician?.secondTitleSecond}
            secondTitleSecondDetails={
              allSamples.electricalEngineeringTechnician?.secondTitleSecondDetails
            }
           
          />
          <Steps tabItem={allSamples.electricalEngineeringTechnician?.steps} />
          <ReportSamples
            fancySteps={allSamples.electricalEngineeringTechnician?.fancySteps}
          />
        </>
      )}
...
{name === "civil-engineering-technician" && (
        <>
          <CDRSample
            ...
            titleDetails={allSamples.civilEngineeringTechnician?.titleDetails}
            image={allSamples.civilEngineeringTechnician?.image}
            secondTitle={allSamples.civilEngineeringTechnician?.secondTitle}
            secondTitleSecond={allSamples.civilEngineeringTechnician?.secondTitleSecond}
            secondTitleSecondDetails={
              allSamples.civilEngineeringTechnician?.secondTitleSecondDetails
            }
...
{name === "civil-engineering-draftsperson" && (
        <>
          <CDRSample
            ...
            titleDetails={allSamples.civilEngineeringDraftsperson?.titleDetails}
            image={allSamples.civilEngineeringDraftsperson?.image}
            secondTitle={allSamples.civilEngineeringDraftsperson?.secondTitle}
            secondTitleSecond={allSamples.civilEngineeringDraftsperson?.secondTitleSecond}
            secondTitleSecondDetails={
              allSamples.civilEngineeringDraftsperson?.secondTitleSecondDetails
            }
           
          />
          <Steps tabItem={allSamples.civilEngineeringDraftsperson?.steps} />
          <ReportSamples
            fancySteps={allSamples.civilEngineeringDraftsperson?.fancySteps}
          />
        </>
      )}
      {name === "telecommunications-field-engineer" && (
        <>
          <CDRSample
            ...
            titleDetails={allSamples.telecommunicationsFieldEngineer?.titleDetails}
            image={allSamples.telecommunicationsFieldEngineer?.image}
            secondTitle={allSamples.telecommunicationsFieldEngineer?.secondTitle}
            secondTitleSecond={allSamples.telecommunicationsFieldEngineer?.secondTitleSecond}
            secondTitleSecondDetails={
              allSamples.telecommunicationsFieldEngineer?.secondTitleSecondDetails
            }
           
          />
          <Steps tabItem={allSamples.telecommunicationsFieldEngineer?.steps} />
          <ReportSamples
            fancySteps={allSamples.telecommunicationsFieldEngineer?.fancySteps}
          />
        </>
      )}
       {name === "electrical-engineer-draftsperson" && (
        <>
          <CDRSample
            ...
            titleDetails={allSamples.electricalEngineeringDraftsperson?.titleDetails}
            image={allSamples.electricalEngineeringDraftsperson?.image}
            secondTitle={allSamples.electricalEngineeringDraftsperson?.secondTitle}
            secondTitleSecond={allSamples.electricalEngineeringDraftsperson?.secondTitleSecond}
            secondTitleSecondDetails={
              allSamples.electricalEngineeringDraftsperson?.secondTitleSecondDetails
            }
           
          />
          <Steps tabItem={allSamples.electricalEngineeringDraftsperson?.steps} />
          <ReportSamples
            fancySteps={allSamples.electricalEngineeringDraftsperson?.fancySteps}
          />
        </>
      )}
